...
1,126/1,152 schema probes; token/service security passes 459/459 scenarios and JWKS
...
130/130, settings schema/encryption/redaction policy 130/130, encrypted settings
persistence 70/70, config HTTP hosting 138/139 and protected bootstrap storage 147/147. The aggregate gate passes 4,453/4,481;
...
| lifecycle | BSB service.ts, bootstrapState.ts | Native ASGI lifespan and ASP.NET hosted service own sync cancellation and service disposal; encrypted atomic bootstrap/identity storage; install/redeem hosting pending | config.md §2; port READMEs | sync_cases.py: exact-loopback, redirect-denied, shutdown-no-retry, cancelled startup and host lifetime; bootstrap_cases.py: file interchange, tampering, identity/redaction, atomic failure and cancellation; installation binding pending |
