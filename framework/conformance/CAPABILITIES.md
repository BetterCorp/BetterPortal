...
1,474/1,482 schema probes: JavaScript/Python pass all checks, while eight C#
...
Before adding the workspace metadata document, the AnyVali 1.1.3
...
|---|---|---|---|---|
| contracts | contracts/*.ts, runtime/jsonSchema.ts | 160 canonical documents embedded in both packages, including derived authoring declarations, project locks, workspace metadata and registry responses; native imports, field selection and portable object composition | manifest.md §4 | schema-cases.json; 1,474/1,482 including all-document round trips; eight C# extension failures block the gate |
