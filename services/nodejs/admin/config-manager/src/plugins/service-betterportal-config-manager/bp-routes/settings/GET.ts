export const operationId = "admin.settings.view";
...
export const dependencies = [
  { operationId: "admin.services.view", method: "GET" },
  { operationId: "admin.routes.view", method: "GET" },
  { operationId: "admin.fragments.view", method: "GET" },
  { operationId: "admin.config.view", method: "GET" }
] as const;
