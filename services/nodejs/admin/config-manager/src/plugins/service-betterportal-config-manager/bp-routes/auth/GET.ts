export const operationId = "admin.auth.view";
...
const DerivedPermissionGrantSchema = av.object({
  roleId: av.string().minLength(1),
  serviceId: av.string().minLength(1),
  viewId: av.string().minLength(1),
  permissions: av.array(PermissionActionSchema).minItems(1),
  requiredBy: av.array(av.object({
    serviceId: av.string().minLength(1),
    operationId: av.string().minLength(1),
    method: av.string().minLength(1)
  })).minItems(1)
...
export const ResponseSchema = av.object({
  ...
  derivedPermissionGrants: av.array(DerivedPermissionGrantSchema).default([]),
