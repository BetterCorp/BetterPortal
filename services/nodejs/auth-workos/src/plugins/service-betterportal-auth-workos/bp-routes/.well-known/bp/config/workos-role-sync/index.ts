...
export const auth: ApiAuthRequirement = { required: true, permissions: [{ serviceId: "service.betterportal.auth.workos", viewId: "workos-role-sync.index", permissions: ["read"] }] };
