...
export const auth: ApiAuthRequirement = { required: true, permissions: [{ serviceId: "service.betterportal.auth.workos", viewId: "workos-role-sync.permissions", permissions: ["create"] }] };
