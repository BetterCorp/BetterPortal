...
export const QuerySchema = av.object({ sessionAfter: av.optional(av.string()), action: av.optional(av.string()), id: av.optional(av.string()), secret: av.optional(av.string()) });
